...
let BoilerplateCard = class BoilerplateCard extends LitElement {
    setConfig(config) {
        ...
        this._config = Object.assign({ name: 'Button Text Card', title: 'Button Text Card Title', subtitle: 'Subtitle' }, config);
    }
    ...
    render() {
        ...
        if (!this._config.icon || this._config.icon === '') {
            ...
            this.setConfig(Object.assign(Object.assign({}, this._config), { icon: hassIcon || 'mdi:alert-circle' }));
        }
        return html `
      <ha-card
    ...
    _renderTemplate(template) {
        return new Promise((resolve, _) => {
            ...
            if (this.hass) {
                this.hass.connection.subscribeMessage((output) => {
                    if (output.result) {
