...
customElements.define('action-handler-button-text-card', ActionHandler);
const getActionHandler = () => {
    const body = document.body;
    if (body.querySelector('action-handler-button-text-card')) {
        return body.querySelector('action-handler-button-text-card');
    }
    const actionhandler = document.createElement('action-handler-button-text-card');
...
var BoilerplateCard_1;
/* eslint no-console: 0 */
console.info(`%c  BUTTON-TEXT-CARD \n%c  v${CARD_VERSION}    `, 'color: orange; font-weight: bold; background: black', 'color: white; font-weight: bold; background: dimgray');
let BoilerplateCard = BoilerplateCard_1 = class BoilerplateCard extends LitElement {
    constructor() {
        super(...arguments);
    ...
    setConfig(config) {
        ...
        this._config = Object.assign({ name: 'Button Text Card', title: '', subtitle: '', large: false }, config);
        // Check if there is a template in a field
        for (const field of BoilerplateCard_1.templateFields) {
            const regResult = BoilerplateCard_1.templateRegex.exec(this._config[field]);
            BoilerplateCard_1.templateRegex.lastIndex = 0;
            if (regResult !== null) {
    ...
    render() {
        ...
        // Render templates
        for (const field of BoilerplateCard_1.templateFields) {
            const regMatches = BoilerplateCard_1.templateRegex.exec(this._config[field]);
            BoilerplateCard_1.templateRegex.lastIndex = 0;
        ...
        if (!this._config.icon || this._config.icon === '') {
            ...
            this.setConfig(Object.assign(Object.assign({}, this._config), { icon: icon, _rendered_icon: icon }));
        }
    ...
    _handleAction(ev) {
        if (this.hass && this._config && ev.detail.action) {
            W(this, this.hass, this._config, ev.detail.action);
        }
    }
    _inEditMode() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        const el = (_h = (_g = (_f = (_e = (_d = (_c = (_b = (_a = document
            .querySelector('home-assistant')) === null || _a === void 0 ? void 0 : _a.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector('home-assistant-main')) === null || _c === void 0 ? void 0 : _c.shadowRoot) === null || _d === void 0 ? void 0 : _d.querySelector('app-drawer-layout partial-panel-resolver ha-panel-lovelace')) === null || _e === void 0 ? void 0 : _e.shadowRoot) === null || _f === void 0 ? void 0 : _f.querySelector('hui-root')) === null || _g === void 0 ? void 0 : _g.shadowRoot) === null || _h === void 0 ? void 0 : _h.querySelector('ha-app-layout app-header');
        if (el) {
...
__decorate([
    property()
], BoilerplateCard.prototype, "_hasTemplate", void 0);
__decorate([
    property()
], BoilerplateCard.prototype, "_stateObj", void 0);
BoilerplateCard = BoilerplateCard_1 = __decorate([
    customElement('button-text-card')
], BoilerplateCard);

export { BoilerplateCard };
