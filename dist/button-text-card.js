 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,n,i){const o=e[0];if("."===o){return new N(t,e.slice(1),n).parts}return"@"===o?[new k(t,e.slice(1),i.eventContext)]:"?"===o?[new T(t,e.slice(1),n)]:new x(t,e,n).parts}handleTextExpression(t){return new P(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
